...
import type { Document as _Document, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getDocumentById(arg0: string): Promise<Document | null> {
        if (this.processError) {
            try {
    ...
    async getMyDocuments(): Promise<Array<Document>> {
        if (this.processError) {
            try {
    ...
    async uploadDocument(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: bigint, arg5: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadDocument(arg0, arg1, arg2, arg3, arg4, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        storage: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.storage),
